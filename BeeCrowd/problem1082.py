...
for i in range(1, N + 1):
    ...
    comp = components(graph) #Retorna um dictionary onde a chave é um componente e a lista são os nodos (inverte a função original)
    ...
    for nc in range(len(comp)):  
        ...
        for a in nodes:
            print(f"{a},", end="")
        print()
    print(f"{len(comp)} connected components")
    print()